...
# 
# mkdir 1h_athey_100 && tar -xzvf 1h_athey_100.tar.gz -C 1h_athey_100 --strip-components 1
# mkdir 1h_athey_500 && tar -xzvf 1h_athey_500.tar.gz -C 1h_athey_500 --strip-components 1
# mkdir 1h_athey_100_learned && tar -xzvf 1h_athey_100_learned.tar.gz -C 1h_athey_100_learned --strip-components 1
# mkdir 1h_athey_500_learned && tar -xzvf 1h_athey_500_learned.tar.gz -C 1h_athey_500_learned --strip-components 1
